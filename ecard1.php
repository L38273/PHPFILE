...
<div class="integration-box">
    ...
    <div class="integration-title">Staychat AI integration with WhatsApp</div>
    <div class="integration-desc">
        Staychat AI WhatsApp integration connects your WhatsApp Business Account to the unified inbox. One-click setup enables two-way messaging, AI-powered automation, and seamless communication throughout the entire guest journey.
    </div>

    <div class="list-title">What You Get:</div>

    <div class="feature-list">
        • All WhatsApp conversations centralized in Staychat AI unified inbox<br>
    ...
    <div class="feature-list">
        <strong>Setup Requirements:</strong> WhatsApp Business Account | One-click integration<br><br>
