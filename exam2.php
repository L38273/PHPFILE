...
.dark-mode .vector-dropdown-content {
  background: #1e1e1e;
  color: #ffffff;
}

.dark-mode .vector-menu-heading,
.dark-mode .cdx-label__label__text {
  color: #ffffff;
}
...
function toggleAppearance() {
  document
    .querySelector('.vector-dropdown-content')
    .classList.toggle('active');
}
</script>
<script>
document.querySelectorAll('input[name="skin-client-pref-skin-theme-group"]').forEach(radio => {
