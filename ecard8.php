...
<div class="integration-box">
    ...
    <img src="https://img.icons8.com/?size=100&id=wA5rN96FVDtq&format=png&color=000000" alt="WhatsApp Logo">
   
    <div class="integration-title">Staychat AI integration with Meta</div>
    <div class="integration-desc">
        Staychat AI Meta integration connects your Meta Account to the unified inbox. One-click setup enables two-way messaging, AI-powered automation, and seamless communication throughout the entire guest journey.
    </div>

    <div class="list-title">What You Get:</div>

    <div class="feature-list">
        • All Meta conversations centralized in Staychat AI unified inbox<br>
    ...
    <div class="feature-list">
        <strong>Setup Requirements:</strong> Meta Account | One-click integration<br><br>
